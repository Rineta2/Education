...
import { headingPengumuman, pengumuman, pengumumanData } from '@/components/Data/Data'
...
export default function Pengumuman() {
  return (
    <section className="pengumuman">

      <div className="pengumuman__container container grid">

        {
          headingPengumuman.map((item) => (
